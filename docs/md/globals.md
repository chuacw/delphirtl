...
- [FormatSettings](classes/FormatSettings.md)
...
- [TIniFile](classes/TIniFile.md)
- [TMemIniFile](classes/TMemIniFile.md)
...
- [PathDelim](variables/PathDelim.md)
- [PathSep](variables/PathSep.md)
...
- [Halt](functions/Halt.md)
- [hasInstanceMethod](functions/hasInstanceMethod.md)
- [hasPrototypeMethodFromConstructor](functions/hasPrototypeMethodFromConstructor.md)
- [HourOf](functions/HourOf.md)
- [isJSONRPCID](functions/isJSONRPCID.md)
- [isLastDayOfMonth](functions/isLastDayOfMonth.md)
...
- [MillisecondOf](functions/MillisecondOf.md)
- [MinuteOf](functions/MinuteOf.md)
- [MonthOf](functions/MonthOf.md)
- [RecodeDay](functions/RecodeDay.md)
- [RecodeHour](functions/RecodeHour.md)
- [RecodeMillisecond](functions/RecodeMillisecond.md)
- [RecodeMinute](functions/RecodeMinute.md)
- [RecodeMonth](functions/RecodeMonth.md)
- [RecodeSecond](functions/RecodeSecond.md)
- [RecodeYear](functions/RecodeYear.md)
- [SecondOf](functions/SecondOf.md)
- [timePerformance](functions/timePerformance.md)
- [toFormat](functions/toFormat.md)
- [WeekOf](functions/WeekOf.md)
- [YearOf](functions/YearOf.md)
